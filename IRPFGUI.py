...
while True:
    ...
    if event == psg.WINDOW_CLOSED or event == 'Fechar':
        ...
        output_text = (
            f'Salário base: ________________________ R${resultado['salario_base']:.2f}\n'
            f'Alíquota: _________________________ {resultado['aliquota'] * 100:.1f}%\n'
            f'IR Devido: __________________________ R${resultado['ir_devido']:.2f}\n'
            f'Salário Líquido: _____________ R$ {resultado['salario_liquido']:.2f}\n'
            f'Alíquota Efetiva: __________________ {resultado['aliquota_efetiva'] * 100:.2f}%'
        )
